...
class SmartEventFilter:
    ...
    def __init__(self):
        ...
        self.excluded_paths = {
            ...
            "/sys",
            "/dev",
            "/tmp",  # nosec B108 - excluding from monitoring, not creating
            "/var/log",
            "/.git",
            "/node_modules",
            "/__pycache__",
        ...
        self.high_priority_paths = {"/home", "/usr/bin", "/usr/local/bin", "/opt"}
    ...
    def should_process_event(self, event: WatchEvent) -> bool:
        ...
        try:
            ...
            if (
                ...
                and event.event_type == WatchEventType.FILE_ACCESSED
            ):
                return False
    ...
    def _schedule_medium_priority(self):
        ...
        if len(self.medium_priority_queue) >= self.medium_priority_batch_size:
            ...
            self.medium_timer = threading.Timer(
                self.medium_priority_timeout, self._process_medium_priority
            )
    ...
    def get_performance_stats(self) -> dict[str, Any]:
        ...
        return {
            **self.stats,
            ...
            "filter_efficiency": (
                self.stats["events_filtered"] / max(self.stats["events_received"], 1)
            )
            * 100,
        }
...
async def test_enhanced_watcher():
    ...
    def event_handler(events: list[WatchEvent]):
        for event in events:
            ...
            print(
                f"   Priority: {event.processing_priority}, "
