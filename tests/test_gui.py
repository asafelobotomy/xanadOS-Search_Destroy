...
class TestRequirements(unittest.TestCase):
    ...
    def test_icons_exist(self):
        ...
        for size in sizes:
            png_icon = os.path.join(icons_dir, f'io.github.asafelobotomy.SearchAndDestroy-{size}.png')
            placeholder = os.path.join(icons_dir, f'io.github.asafelobotomy.SearchAndDestroy-{size}.png.placeholder')
