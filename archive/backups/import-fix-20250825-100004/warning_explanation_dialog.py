...
Provides detailed explanations and gui        try:
            return get_theme_manager().get_color(color_key)
        except (AttributeError, KeyError):
            # Fallback colors for when theme manager isn't available
            fallback_colors = {
                "background": "#2b2b2b",
                "foreground": "#ffffff",
                "muted_text": "#8C8C8C",
            ...
            return fallback_colors.get(color_key, "#FFCDAA")warnings
"""
...
from app.core.rkhunter_wrapper import RKHunterFinding
