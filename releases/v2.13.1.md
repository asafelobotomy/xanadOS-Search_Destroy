...
Thank you to all users who reported the setup dialog issue and provided feedback that helped improve
the user experience. Special thanks to contributors who helped with testing and validation.

---

**Full Changelog**:
<https://github.com/asafelobotomy/xanadOS-Search_Destroy/compare/v2.11.1...v2.13.1>
