...
for size in "${icon_sizes[@]}"; do
    icon_file="packaging/icons/io.github.asafelobotomy.SearchAndDestroy-${size}.png"
    if [[ -f "$icon_file" ]]; then
...
sed -i "s/commit: REPLACE_WITH_ACTUAL_COMMIT_HASH/commit: $COMMIT_HASH/" packaging/flatpak/io.github.asafelobotomy.SearchAndDestroy.yml
...
echo "   - io.github.asafelobotomy.SearchAndDestroy.yml"
echo "   - io.github.asafelobotomy.SearchAndDestroy.metainfo.xml"
echo "   - io.github.asafelobotomy.SearchAndDestroy.desktop"
