...
class ThemeManager(QObject):
        ...
        self._theme_definitions = {
            "dark": {
                ...
                "colors": {
                    ...
                    # Warm coral for inner borders and subdivisions (less pink, more coral)
                    "border_inner": "#ff8a80",
                    # Subtle borders that blend well (for very minimal divisions)
                    "border_muted": "#404040",
            ...
            "light": {
                ...
                "colors": {
                    ...
                    # Summer: Sky Blue → Seafoam → Peach → Yellow
                    "header_bg": "qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #87CEEB, stop:0.33 #93E9BE, stop:0.66 #FFE5B4, stop:1 #FDFD96)",
                    ...
                    "secondary_bg": "qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #f0fbff, stop:1 #e6f9ff)",
                    # Subtle seafoam gradient
                    "tertiary_bg": "qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #f0fff4, stop:1 #e6fffa)",
                    # Clean white to light blue
                    "card_bg": "qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #ffffff, stop:1 #f9fcff)",
                    # White to light yellow
                    "elevated_bg": "qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #ffffff, stop:1 #fffef0)",
                    ...
                    # Sky blue to seafoam gradient borders
                    "border": "qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #87CEEB, stop:1 #93E9BE)",
                    ...
                    # Seafoam to peach separators
                    "separator": "qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #93E9BE, stop:1 #FFE5B4)",
                    # Refreshing Interaction Feedback
                    # Sky blue hover
                    "hover_bg": "qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #f0fbff, stop:1 #e6f9ff)",
                    # Seafoam hover
                    "hover_accent": "qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #f0fff4, stop:1 #e6fffa)",
                    # Deeper sky blue pressed
                    "pressed_bg": "qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #e6f9ff, stop:1 #d1f2ff)",
    ...
    def _set_application_palette(self):
        ...
        palette.setColor(
            ...
            hex_to_qcolor(self.get_color("selection_text")),
        )
        ...
        palette.setColor(
            ...
            hex_to_qcolor(self.get_color("disabled_text")),
        )
        palette.setColor(
            QPalette.ColorGroup.Disabled,
        ...
        palette.setColor(
            ...
            hex_to_qcolor(self.get_color("disabled_bg")),
        )
        palette.setColor(
            QPalette.ColorGroup.Disabled,
    ...
    def create_themed_message_box(
        self, parent: QWidget, msg_type: str, title: str, text: str, buttons=None
    ) -> QMessageBox:
