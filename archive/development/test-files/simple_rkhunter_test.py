#!/usr/bin/env python3
"""
Simple script for RKHunter availability detection - standalone version

Note: Renamed purpose to avoid pytest picking this up as a test module
from the archive; keep as a runnable demo script.
"""
import os
import logging
