...
echo "   mkdir org.xanados.SearchAndDestroy"
echo "   cd org.xanados.SearchAndDestroy"
echo "   cp $(pwd)/packaging/flatpak/org.xanados.SearchAndDestroy.yml ."
echo "   cp $(pwd)/packaging/flatpak/org.xanados.SearchAndDestroy.metainfo.xml ."
echo "   cp $(pwd)/packaging/flatpak/org.xanados.SearchAndDestroy.desktop ."
echo "   cp $(pwd)/packaging/flatpak/python3-requirements.json ."
echo "   cp $(pwd)/packaging/flatpak/flathub.json ."
echo ""
echo "5. 🔧 Update commit hash in manifest:"
echo "   sed -i \"s/commit: REPLACE_WITH_ACTUAL_COMMIT_HASH/commit: $CURRENT_COMMIT/\" org.xanados.SearchAndDestroy.yml"
echo ""
echo "6. ✅ Validate submission:"
echo "   flatpak run --command=flatpak-builder-lint org.flatpak.Builder manifest org.xanados.SearchAndDestroy.yml"
echo ""
echo "7. 🔨 Test build (recommended):"
echo "   flatpak run --command=flathub-build org.flatpak.Builder org.xanados.SearchAndDestroy.yml"
echo ""
echo "8. 📤 Submit to Flathub:"
echo "   git add ."
echo "   git commit -m \"Add org.xanados.SearchAndDestroy\""
...
echo "   Title: \"Add org.xanados.SearchAndDestroy\""
echo ""
...
echo "   • Local Build Testing: $(pwd)/scripts/test-flatpak-build.sh"
echo ""
