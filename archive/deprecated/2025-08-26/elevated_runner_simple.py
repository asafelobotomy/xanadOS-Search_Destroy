...
Archive Type: deprecated
Retention: 1 year (review annually)
Original Location: app/core/elevated_runner_simple.py

Note: This file is archived for historical reference only and is not used by the application.
"""
