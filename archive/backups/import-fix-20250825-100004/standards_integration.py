...
from .system_paths import SystemPaths, ApplicationPaths, APP_PATHS
from .security_standards import SecurityStandards, SecurityLevel, SecurityPolicy
from .process_management import SecureProcessManager, ProcessConfig, PROCESS_MANAGER
from .performance_standards import PerformanceOptimizer, PerformanceLevel, PERFORMANCE_OPTIMIZER
...
def get_app_config(level: ConfigurationLevel = ConfigurationLevel.STANDARD) -> Dict[str, Any]:
