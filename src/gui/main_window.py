...
class MainWindow(QMainWindow):
    ...
    def create_real_time_tab(self):
        ...
        status_group = QGroupBox("Real-Time Protection Status")
        ...
        self.start_protection_btn = QPushButton("▶️ Start Protection")
        self.start_protection_btn.clicked.connect(self.start_real_time_protection)
        
        self.stop_protection_btn = QPushButton("⏹️ Stop Protection")
        self.stop_protection_btn.clicked.connect(self.stop_real_time_protection)
        self.stop_protection_btn.setEnabled(False)
        
        controls_layout.addWidget(self.start_protection_btn)
        controls_layout.addWidget(self.stop_protection_btn)
        controls_layout.addStretch()
    ...
    def start_real_time_protection(self):
        ...
        try:
            if self.real_time_monitor and self.real_time_monitor.start():
                self.protection_status_label.setText("🛡️ Protection Active")
                self.protection_status_label.setStyleSheet("color: green; font-weight: bold;")
                self.start_protection_btn.setEnabled(False)
                ...
                self.protection_status_label.setText("❌ Failed to start protection")
