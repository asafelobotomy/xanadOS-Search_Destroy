...
def elevated_run(argv: Sequence[str], *, timeout: int = 300, capture_output: bool = True,
    ...
    return _simple_legacy_elevated_run(argv, timeout=timeout, capture_output=capture_output, text=text, gui=gui)


def _simple_legacy_elevated_run(argv: Sequence[str], *, timeout: int = 300, capture_output: bool = True,
                               text: bool = True, gui: bool = True) -> subprocess.CompletedProcess:
    """
