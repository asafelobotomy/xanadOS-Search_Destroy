...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, 
                             ...
                             QScrollArea, QGridLayout, QGroupBox, QTabWidget,
...
from PyQt6.QtGui import QFont, QPalette, QPixmap, QIcon, QColor, QTextCharFormat, QTextCursor
import logging
...
class RKHunterOptimizationTab(QWidget):
    ...
    def setup_ui(self):
        ...
        # Initial state
        self.progress_label.setText("Click 'Refresh Status' to check current RKHunter configuration")
